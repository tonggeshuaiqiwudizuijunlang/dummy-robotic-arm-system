...
#include "bsp_api.h"
                ...
                #include "task.h"
                #include "semphr.h"
                extern void motor_ctrl_task_create(void);
                extern TaskHandle_t motor_ctrl_task;
extern void daemon_task_create(void);
                extern TaskHandle_t daemon_task;
extern void robot_task_create(void);
                extern TaskHandle_t robot_task;
